...
public class MySharedPreference {
    ...
    private static MySharedPreference sSharedPrefs;
    ...
    public static void initSharedPref(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new MySharedPreference(context.getApplicationContext());
        }
    }
     ...
     */
    public enum Key {
        USER_ID, USER_TOKEN, IS_LOGIN, USER_PHONE_NUMBER,USER_NAME, IS_LIVE, IS_NEW_UPDATE, APP_UPDATE_SUPPRESED_VERSION, APP_OPEN_COUNT, MY_CART
    }
